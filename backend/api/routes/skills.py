...
SKILL_CATALOG: list[dict] = [
    ...
    # AI & ML (MORE)
    # ═══════════════════════════════════════════════════════════════
    {"id": "fine-tuning", "name": "Model Fine-Tuning", "description": "Fine-tuning de LLMs: LoRA, QLoRA, dataset prep, hyperparameter tuning.", "category": "ai", "icon": "🔧", "color": "#7c3aed", "author": "Community", "version": "1.0.0", "tags": ["fine-tuning", "lora", "training", "llm"], "compatible_agents": ["developer", "researcher"]},
    ...
    {"id": "legal-contracts", "name": "Legal Contracts", "description": "Templates de contratos: NDA, SLA, ToS, privacy policy, EULA.", "category": "business", "icon": "⚖️", "color": "#44403c", "author": "Community", "version": "1.0.0", "tags": ["legal", "contracts", "nda", "terms", "privacy"], "compatible_agents": ["writer", "orchestrator"]},
    # ═══════════════════════════════════════════════════════════════
    # MEDIA & CREATIVE (MORE)
    # ═══════════════════════════════════════════════════════════════
    {"id": "audio-processing", "name": "Audio Processing", "description": "Processamento de áudio: noise reduction, EQ, compression, mixing.", "category": "media", "icon": "🎧", "color": "#7c2d12", "author": "Community", "version": "1.0.0", "tags": ["audio", "processing", "mixing", "noise-reduction"], "compatible_agents": ["designer"]},
    ...
    {"id": "webhook-manager", "name": "Webhook Manager", "description": "Gerencia webhooks: routing, retry, signing, payload transformation.", "category": "automation", "icon": "🪝", "color": "#6d28d9", "author": "Community", "version": "1.0.0", "tags": ["webhook", "events", "routing", "integration"], "compatible_agents": ["developer", "devops"]},
