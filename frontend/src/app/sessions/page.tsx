...
export default function SessionsPage() {
  ...
  const [memories, setMemories] = useState<
    { id: number; content: string; tags: string[]; created_at: string }[]
  >([]);
              ...
              <table className="w-full text-left">
                <thead>
                  <tr style={{ borderBottom: "1px solid var(--glass-border)" }}>
                    {["Session", "Agent", "Messages", "Created", "Actions"].map(
                      (h) => (
                        <th
                          key={h}
          ...
          <div className="p-4">
            <div className="mb-4">
              ...
              <p
                ...
                style={{ color: "var(--text-ghost)" }}
              >
                Each conversation with an agent creates a session. Sessions
                store the full message history so you can resume conversations
                later, or review past interactions.
              </p>
            </div>
