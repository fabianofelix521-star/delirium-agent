        ...
        >
          ...
          >
            ...
            <input
              ...
              value={newMsg.to_agent}
              onChange={(e) =>
                setNewMsg({ ...newMsg, to_agent: e.target.value })
              }
            ...
            <textarea
              ...
              className="w-full px-3 py-2 rounded-lg text-xs h-24 resize-none"
              style={inputStyle}
            />
            <div className="flex justify-end gap-2">
              ...
              <button
                onClick={sendMessage}
                className="px-4 py-2 rounded-lg text-xs font-medium btn-primary"
              >
                Send
              </button>
            </div>
        ...
        >
          ...
          >
            ...
            <textarea
              ...
              className="w-full px-3 py-2 rounded-lg text-xs h-20 resize-none"
              style={inputStyle}
            />
            <input
